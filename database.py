...
def create_testdata():
    ...
    transfer1 = Transfer(1003.45,"2017-03-22 23:05:00","Ueberweisung 1",account1,account2,"Gabi Musterfrau")
    transfer2 = Transfer(13.30,"2017-03-22 13:05:00","Ueberweisung 2",account2,account3,"Erika")
    transfer3 = Transfer(9003.20,"2017-03-22 15:47:00","Ueberweisung 3",account2,account1,"Mustermann Max")
    transfer4 = Transfer(904.40,"2017-03-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test")
    transfer5 = Transfer(5343.22,"2017-03-22 08:55:00","Ueberweisung 5",account3,account1,"Max")
    transfer6 = Transfer(690.30,"2017-03-22 11:32:00","Ueberweisung 6",account3,account2,"Gabi")
    transfer7 = Transfer(14.10,"2017-04-03 09:15:00","Ueberweisung 7",account1,account2," Musterfrau")
    transfer8 = Transfer(105.45,"2017-03-28 19:22:00","Ueberweisung 8",account1,account3,"E. Test")
    ...
    db_session.add(Transfer(904.40,"2017-02-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(94.40,"2017-03-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(9.20,"2017-04-02 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(1002.40,"2017-01-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(504.40,"2016-12-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(94.40,"2016-10-12 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(90.40,"2016-11-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(24.40,"2017-03-13 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(404.40,"2017-03-08 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(14.40,"2016-09-22 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(847.40,"2016-09-02 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(104.40,"2016-11-15 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(25.40,"2016-12-23 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
    db_session.add(Transfer(98.40,"2016-12-24 12:12:00","Ueberweisung 4",account1,account3,"Erika Test"))
